...
import { CdkEksExecRoleConstruct } from "./iam/eks-exec"
...
export class FastishRoles extends cdk.NestedStack {
  ...
  public eksExec: Role         // EKS-specific execution permissions
  ...
  constructor(scope: Construct, id: string, props?: cdk.NestedStackProps) {
    ...
    // EKS-specific execution role with EKS permissions
    this.eksExec = new CdkEksExecRoleConstruct(scope, id).role
  }
}
